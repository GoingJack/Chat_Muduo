...
const int MSG_ACK_ADD_FRIEND = 20;//accept friend request
const int MSG_ACK_ADD_FRIEND_ACK = 21;

const int MSG_CHAT_GROUP = 22;//send msg to server
const int MSG_CHAT_GROUP_ACK = 23;

const int MSG_CHAT_GROUP_RECV = 24;//recv msg from group
